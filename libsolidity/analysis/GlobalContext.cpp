...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("revertdiy", make_shared<FunctionType>(strings(), strings(), FunctionType::Kind::RevertDIY, false, StateMutability::Pure)),
	make_shared<MagicVariableDeclaration>("revertdiy", make_shared<FunctionType>(strings{ "string memory" }, strings(), FunctionType::Kind::RevertDIY, false, StateMutability::Pure)),
	...
	make_shared<MagicVariableDeclaration>("db", make_shared<MagicType>(MagicType::Kind::Database))
})
{
}
