...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::CREATETABLE, { "CREATETABLE",    0, 5, 1, true, Tier::High} },
	{ Instruction::EXDROPTABLE, { "EXDROPTABLE",    0, 2, 1, true, Tier::High} },
	{ Instruction::EXRENAMETABLE,   { "EXRENAMETABLE",  0, 5, 1, true, Tier::High} },
	{ Instruction::EXINSERTSQL, { "EXINSERTSQL",    0, 5, 1, true, Tier::High} },
	{ Instruction::EXDELETESQL, { "EXDELETESQL",    0, 5, 1, true, Tier::High} },
	{ Instruction::EXUPDATESQL, { "EXUPDATESQL",    0, 7, 1, true, Tier::High} },
	{ Instruction::EXSELECTSQL, { "EXSELECTSQL",    0, 5, 1, true, Tier::High} },
	{ Instruction::EXTRANSBEGIN,{ "EXTRANSBEGIN",   0, 0, 0, true, Tier::High} },
	{ Instruction::EXTRANSCOMMIT,   { "EXTRANSCOMMIT",  0, 0, 1, true, Tier::High} },
	{ Instruction::EXGRANTSQL,  { "EXGRANTSQL",     0, 6, 1, true, Tier::High} },
	{ Instruction::EXGETROWSIZE,    { "EXGETROWSIZE",   0, 1, 1, true, Tier::High} },
	{ Instruction::EXGETCOLSIZE,    { "EXGETCOLSIZE",   0, 1, 1, true, Tier::High} },
	{ Instruction::EXGETVALUEBYKEY, { "EXGETVALUEBYKEY",    0, 4, 1, true, Tier::High} },
	{ Instruction::EXGETVALUEBYINDEX,   { "EXGETVALUEBYINDEX",  0, 3, 1, true, Tier::High} },
